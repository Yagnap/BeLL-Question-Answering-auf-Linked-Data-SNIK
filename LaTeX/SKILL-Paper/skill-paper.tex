...
\item herausfinden wie das offiziell heißt, Lernkurve?
  \begin{itemize}
    ...
    \item Liegt also entweder am Traning von QAnswer oder an uns, ich würde im Rahmen vom Paper eventuell zumindest nochmal nach Ursachen zu gucken versuchen?
  \end{itemize}
\end{itemize}
