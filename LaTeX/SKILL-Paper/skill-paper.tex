...
%\input{Acronym.tex}
\todo{ich weiss nicht warum, aber bei mir seite 1 als seite 11 angezeigt und das weitere verschiebt sich auch im PDF viewer, die letzte ist 22.}
...
\todo{da die Corona Maßnahmen jetzt nicht mehr bestehen kann der Satz weg denke ich}
...
\todo{die letzten Sätze zusammenfassen}
...
Sie beschreiben Personen, Informationen im Krankenhaus und Funktionen.\todo{respektive}
...
DeepPavlov \cite{deeppavlov} ist ein hochmodulares, hochflexibles System mit der Oberfläche eines Chatbots, leider aber nur für ODQA und deshalb nicht weiter nützlich für dieses Problem.\todo{der Satz ergibt keinen Sinn. open domain beinhaltet doch closed domain}
...
Für \texttt{meta:entityTypeComponent} wird \enquote{facets} hinzugefügt.\todo{aurl benutzen}
...
Für diese stehen die Lexikalisierungen zur Verfügung.\todo{versuch mal möglichst die Absätze zu füllen, also hier zb ein wort entfernen oder einige hinzufügen}
...
Die Graphen der Lehrbuchfragen sehen denen der automatisch generierten auf den ersten Blick nicht sehr ähnlich aus,\todo{Grammatik}
...
\todo{diskussion der ergebnisse aus diesem kapitel in das diskussionskapitel verschieben}
\section{Diskussion und Ausblick}
\todo{darauf hinweisen dass recall, precision und f-score identisch sind und erklärung versuchen zu finden. eventuell können die überflüssigen graphen dann weg, wenn die eh alle gleich sind.}
...
ChatGPT \footnote{https://openai.com/blog/chatgpt} und andere auf künstlicher Intelligenz nutzende Dialogsysteme haben in letzter Zeit die öffentliche Diskussion beherrscht.
...
Ich möchte Dr. Konrad Höffner für seine enge Betreuung und das Korrekturlesen danken, sowie Dr. Dennis Diefenbach bei der Hilfe bei der Konfiguration QAnswers.\todo{dennis hat noch mehr gemacht, er hat es ja auch für uns bereitgestellt, würde da noch ein Wort hinzufügen}
