...
\begin{figure}%[h!]
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Durchschnittliche Präzision bei den automatisch generierten Testfragen in Abhängigkeit zur Anzahl der generierten Trainingsfragen.}\label{plot:genfscore}
  \end{center}
\end{figure}
...
\begin{figure}%[h!]
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Durchschnittlicher Recall bei den automatisch generierten Testfragen in Abhängigkeit zur Anzahl der generierten Trainingsfragen.}\label{plot:genfscore}
  \end{center}
\end{figure}
