...
\todo{Die richtige Abfrage wäre hier die Vereinigung (disjunktion) all dieser drei Properties, also meta:isResponsibleForEntityType|meta:isRes...Function|meta:isRes...EntityType. Man könnte theoretisch auch argumentieren, dass Rollen nicht mitgemeint sind, weil die who und nicht what sind aber da müsste man mal Franziska fragen.}
...
\todo{ah ja hier vereinigst du es ja. filter geht auch aber mit dem modernen SPARQL 1.1 kann man die im Kommentar oben gezeigten property pfade benutzen, die sind eleganter und ich könnte mir auch vorstellen, dass die schneller ausgeführt werden, wobei das wohl auf die implementierung ankommt und ich das nicht beweisen kann.}
