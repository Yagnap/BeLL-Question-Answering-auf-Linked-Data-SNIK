...
Der Ansatz, um die Fragen zu erhalten, ist, die bereits durch \citet{arneba} klassifizierten Fragen aus \citet{bb} zu verwenden.\todo{bitte auf die Fragen
verlinken, die müssten im Git Repository der Bachelorarbeit von Arne sein, \url{https://github.com/snikproject/quiz-ba} ist allerdings privat , oder du stellst sie in dein Git Repositry. }
