...
\begin{itemize}
  ...
  \item Telemicroscopy (\aurl{bb}{Telemicroscopy})
  \item Teleradiology (\aurl{bb}{Teleradiology})
  \item Transinstitutional Health Care Function \\
  (\aurl{bb}{TransinstitutionalHealthCareFunction})
\end{itemize}
...
\begin{itemize}
  ...
  (\aurl{bb}{ItEvaluationStudyManagementAndExecution})
...
\begin{itemize}
  ...
  \item Strategic Decision (\aurl{bb}{StrategicDecision})
...
Für die Frage nach dem Prädikat ist die Zeichenkette immer \enqutoe{How are ?sl and ?ol related?}, wobei \texttt{?sl} für das Label des Subjekts und \texttt{?ol} für das Label des Objekts steht.
...
\todo{Query für Frage nach Objekt & Frage nach Prädikat umformen; Erst machen wenn wacher}
