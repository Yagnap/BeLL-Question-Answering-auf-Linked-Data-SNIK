...
\todo{Fragetypen/was ist geeignet?}
Ausdrückbar durch SPARQL-Query
Antwort: Mengen (mind. 0) von Ressourcen, Literale
Existenz der Elemente der Menge (affirmative q. ja/nein: leer/nicht leer)
NICHT Größe d. Menge: pädagogisch nicht sinnvoll, da Ontologie unvollständig => open world assumption (nicht sämtliches existierendes Wissen in SNIK vorhanden)
KEINE Aggregate (Summe, Durchschnitt, ...): siehe oben; keine statistischen Daten
NICHT erklären/...
==> Darauf basierend: nur faktische Fragen (andere Fragetypen: temporal (Info nicht vorhanden), prozedurales (wie; aus Tripeln schlecht ableitbar), kausal (warum; aus Tripeln schlecht ableitbar), geographische, ...)
Metamodell: Wer macht was womit, nicht warum/wann/wie/...

komplexesimple; keine zusammengesetzten Fragen nach \cref{def:zfrage}
...
Zuerst
Im Folgenden werden, auf Grundlage von \citet{arneba}, die Fragen aus \citet{bb}
