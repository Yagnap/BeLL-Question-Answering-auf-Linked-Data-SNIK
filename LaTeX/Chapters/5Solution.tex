...
\textbf{Frage \texttt{8.6/2}:} What are major IT evaluation methods?\todo{Frage Antworten & SPARQL ändern, sodass nur noch bb:QualitativeEvaluationMethod und bb:QuantitativeEvaluationMethod als Antworten da sind - vllt über Chapter?}
...
\todo{Query für Frage nach Objekt und Frage nach Prädikat umformen; Erst machen wenn wacher}
