...
\todo{Konrad: so in etwa beispiel bringen:}
In SNIK tritt Homonymität zwischen einigen in mehren Büchern verwendeten Begriffen mit leicht unterschiedlicher Bedeutung auf.
Beispielsweise ist laut \citet{he} ein \enquote{Anwendungssystem} eine Kombination von Anwendungsprogramme(en) und Daten und entspricht somit nicht dem in \citet{ob} verwendeten Oberbegriff \enquote{Anwendungssystem}, der auch eine papierbasierte Fieberkurve mit einschließt, sondern dem \enquote{rechnerbasierten Anwendungssystem}.
...
\begin{align*}
\text{Seien } M_1, M_2, \ldots, M_n \text{ Mengen, sowie } M_1 \subseteq M_2 \subseteq \ldots \subseteq M_n \subseteq M_1
n \in \mathbb{N}, 1 < n \\
...
\text{Daraus folgt aufgrund der Transitivität von } \subseteq: M_i \subseteq M_n \text{ sowie } M_i \supseteq M_1 \\
\text{Da } M_1 = M_n \text{ gilt nun } M_i \subseteq M_1 \land M_1 \subseteq M_i \\
\text{Sodass } M_i = M_1 = M_n \forall i \text{ q.e.d.} \\
\end{align*}
...
\begin{definition}[Einfache Frage]
...
\begin{definition}[Komplexe Frage]
...
\begin{definition}[Zusammengesetzte Frage]
