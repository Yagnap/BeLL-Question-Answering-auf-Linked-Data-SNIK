...
\todo{lstlisting sprache auf sparql stellen, für syntax highlighting. ich glaube sparql gibt es nicht aber sql müsste halbwegs gehen.}
\begin{lstlisting}
...
\todo{nicht snik website sondern snik sparql endpunkt}
...
\begin{definition}[Question Answering]\todo{question answering steht zweimal hintereinander}
