...
\todo{Punkt doppelt. Den Pfeil gibt es nur in SNIK Graph, das kennt der Leser an dieser Stelle aber noch nicht.}

\subsection{Der SNIK-Graph}
\todo{ist das für die Arbeit relevant? wenn ja, würde sich ein Screenshot anbieten zur Visualisierung eines oder mehrerer Beispiele.}
...
\todo{JSON kann man heutzutage in sehr vielen Programmiersprachen benutzen, zumindest wenn man entsprechende Bibliotheken einbindet.}
...
\todo{inzwischen QALD 10, siehe \url{https://www.nliwod.org/challenge}}
...
\todo{bitte noch begründen, warum das nicht verwendet wurde wenn es hier so angepriesen wird. Open Domain Systeme können ja auch closed domain Fragen beantworten, schwieriger wird es umgekehrt.}
...
\todo{DBpedia ist keine Ontologie sondern eine Wissensbasis, beinhaltet allerdings auch eine kleine DBpedia Ontologie. Wikidata ist soweit ich weiß weder Ontologie noch Wissensbasis.}
...
Es ist leider nicht open-source, steht online\footnote{\url{https://app.qanswer.ai/}} aber frei zur Verfügung und wird es nach Nachfrage auch für mindestens die nächsten zwei Jahre noch bleiben.
\todo{die nächsten zwei Jahre ist ungenau. stattdessen Jahr hinschreiben.}
