...
Das erste Problem befasst sich mit der Situation, dass ein Question Answering-System nicht gut selbst entwickelt werden kann.\todo{statt "nicht gut" würde ich sowas schreiben wie du in der Einleitung geschrieben hast, dass es sehr aufwändig ist und nicht im Rahmen dieser Arbeit möglich ist}
\todo{hier fehlt logisch noch ein satz wie "daher soll kein system selbst entwickelt sondern ein existierendes angepasst werden".}
