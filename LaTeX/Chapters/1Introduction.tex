...
\begin{itemize}
	...
	\item Problem P2: Fehlende Intuitivität und Expressivität anderer Lösungsansätze\todo{Ich würde hier eher von existierenden Lösungen schreiben statt von anderen Lösungsansätzen.}
\end{itemize}
...
\todo{bitte noch kurz begründen, warum die Probleme und Ziele verbunden sind. Es ist sonst nicht auf Anhieb offensichtlich, warum Z1 (Benchmark) aus dem Problem P1 (Aufwand) folgt.}
	\begin{itemize}
