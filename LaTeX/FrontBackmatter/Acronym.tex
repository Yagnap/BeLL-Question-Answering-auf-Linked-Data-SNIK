...
\acro{boa}[BOA]{Bootstrapping the Web of Data}
% C
...
\acroplural{iri}[IRIs]{Internationalized Resource Identifiers}
% J
\acro{json}[JSON]{JavaScript Object Notation}
% K
\acro{kb}[KB]{Wissensbasis}
\acroplural{kb}[KBs]{Wissensbasen}
...
% S
\acro{sqa}[SQA]{Semantisches Question Answering}
