...
\documentclass[ ngerman, %twoside,
                openright,titlepage,numbers=noenddot,%1headlines,
                headinclude,footinclude,cleardoublepage=empty,abstract=on,
                BCOR=5mm,paper=a4,
                fontsize=12pt % 12pt ist Schulvorgabe
                ]{scrreprt}
...
\pagenumbering{arabic} % für Schulvorgabe
...
\cleardoublepage
\part*{Appendix}
\include{Chapters/ATagging}
\include{Chapters/BTextbookQuestions.tex}
