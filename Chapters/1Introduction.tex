...
%************************************************
\todo{Den Beispieltext aus der Vorlage überall rausnehmen wenn du das jeweilige Kapitel füllst.}
...
\section{Gegenstand}
\todo{Es geht nicht nur um Personal bei der MI. Suche dir mal eine eingängige Definition und zitiere die.}
...
Es fasst Informationen aus drei Lehrbüchern, welches es in semantischer Weise modelliert und publiziert.\todo{Nicht nur Information sondern Wissen.}
In der Wissensbasis sind Zusammenhänge und Verbindungen zwischen verschiedenen Informationen vorhanden, welche auf dem öffentlich erreichbaren Graph dargestellt sind.\todo{Graph hast du hier noch nicht definiert.}

Diese Daten liegen strukturiert und für Menschen nicht leicht lesbar vor, daher braucht es andere Methoden, durch sie zu navigieren.\todo{Strukturiert ist nichts schlimmes, es klingt so als würde sich das daher auch mit darauf beziehen.}
...
\todo{Ein SPARQL Endpunkt ist keine Sprache, SPARQL ist eine Sprache. Durchsuchung trifft es nicht ganz.}
\section{Problemstellung}

Momentan müssen Studierende der Medizininformatik, die nach Wissen suchen wollen, eine der drei oben genannten Optionen verwenden.\todo{oben nummerieren, geht auch inline. Außerdem sagst du dort "zum Beispiel" aber hier gibt es nur noch genau die drei.}
Alle dieser Möglichkeiten haben jedoch große Nachteile.\todo{jeden Satz auf eine separate Zeile. Das ist besser fürs git.} Der RDF-Browser gibt nur ein sehr beschränktes Ergebnis aus, und RDF selbst zu lesen ist schwer und unpraktisch.
...
\todo{RDF selbst kann man nicht lesen, sondern eines der Serialisierungsformate.}
...
\end{itemize}
\todo{nimm mal den ganzen Vorlagetext raus}
