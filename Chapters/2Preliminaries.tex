...
\begin{table}[h]\centering\scriptsize
  \begin{tabulary}{\textwidth}{rcl}
    ...
    \aurl{ex}{ErikaMustermann} & \aurl{rdf}{type} & \aurl{ciox}{ChiefInformationOfficer} \\
  %  \aurl{}
    \bottomrule
  \end{tabulary}
