...
Informationen hingegen sind Fakten, die gegebenenfalls aus Daten hervorgehen, also zum Beispiel die Information, dass Frau Musterfrau verantwortlich für das jährliche IT-Budget des Uniklinikum Leipzigs ist.
...
\daurl{bb}{http://www.snik.eu/ontology}
\subsection{RDF}
\todo{Beispiele aus https://www.snik.eu/ontology/bb statt dbpedia}
\begin{table}[h]\centering\scriptsize
  \begin{tabulary}{\textwidth}{rcl}
    ...
    \aurl{bb}{ChiefInformationOfficer} \\ \aurl{meta}{isResponsibleForEntityType} \\ \aurl{bb}{AnnualITBudget} \\
    \bottomrule
  \end{tabulary}
...
Aus dem vorherigen Beispiel ist also Frau Musterfrau ein Element der Klasse Leiterin des Informationsmanagements.
...
Es wird teilweise auch zwischen A- und TBoxen unterschieden. \todo{abox wissensbasis, tbox taxonomie}
...
Man kann A- und TBoxen deshalb auch \emph{Wissensbasen} nennen.
...
Bei Wissensbasen können Individuen Relationen mit anderen Individuen sein. \todo{relationale datenbanken können n-stellig sein, wissensbasen nur 2-stellig}
...
\subsubsection{Regelbasiertes System}
...
\acf{nlp} ist die automatische Verarbeitung von natürlicher Sprache, also Sprache, wie sie Menschen sprechen und schreiben.
