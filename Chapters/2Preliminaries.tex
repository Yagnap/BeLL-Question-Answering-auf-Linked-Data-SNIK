...
\subsection{Begriff und Konzept}

Ein \emph{Begriff} ist ein Wort, welches ein

\subsection{Synonyme und Homonyme}

Synonyme existieren, wenn zwei Begriffe auf das gleiche Konzept verweisen.
...
Die Lexik beschreibt die Wortarten.
...
Die Form unflektierbarer Wortarten ist unveränderlich, sie enthalten Partikel wie Adverbien und Interjektionen . %todo: \citep[S.~505]{deutschbuch}
...
\daurl{coix}{http://www.snik.eu/ontology/coix/}
...
\begin{table}[h]\centering\scriptsize
  \begin{tabulary}{\textwidth}{rcl}
    ...
    \aurl{ex}{ErikaMustermann} & \aurl{rdf}{type} & \aurl{coix}{ChiefInformationOfficer} \\
  %  \aurl{}
    \bottomrule
  \end{tabulary}
...
Beim zweiten Beispiel ist wichtig, dass \aurl{bb}{ChiefInformationOfficer} und \aurl{coix} nicht auf das gleiche Wissen zeigen.
...
\caption[Beispielhafter Syntaxbaum]{Beispielhafter Syntaxbaum. Erstellt mit \url{www.mshang.ca/syntree} und \citet{grammarparser}. \emph{S: Sentence; NP: noun phrase; VP: verb phrase; ADJP: adjective phrase; PP: prepositional phrase}.
