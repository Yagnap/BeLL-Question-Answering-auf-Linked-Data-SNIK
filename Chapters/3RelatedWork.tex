...
\begin{figure}[htbp!]
\centering
\includegraphics{Images/DeepPavlovArchitecture.png}%[width=.8\textwidth, height=.9\textheight, keepaspectratio]
\caption[SNIK Metamodell Version 8]{Die Architektur von DeepPavlov. Quelle: \citet{deeppavlov}}
