...
Entitäten werden durch Dreiecke, Quadrate oder Kreise dargestellt und vertreten die verschiedenen Entitäten.
...
TeBaQA \citep{tebaqa} wird von der DICE group an der Universität Paderborn entwickelt.
